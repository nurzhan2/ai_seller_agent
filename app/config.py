...
class Settings(BaseSettings):
    ...
    #
    # ДЕФОЛТ ВЫКЛЮЧЕН после инцидента 2026-08-27: первый боевой проход
    # поллера разослал 21 сообщение в старые чаты живых клиентов. Включать
    # обратно — только вручную и после разбора причины в отдельной сессии,
    # не флагом на деплое.
    ...
    # появится гейт на факт оплаты/предоплаты.
    #
